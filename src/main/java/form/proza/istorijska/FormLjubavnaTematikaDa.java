...
public class FormLjubavnaTematikaDa extends OpstaEkranskaForma{
	...
	{  	
		lblPitanje.setText("Da li želite da delo bude obimno ili kraće");
	...
	void postavibtnKraceDelo(){
		...
		btnKraceDelo.setText("Kraće delo");
